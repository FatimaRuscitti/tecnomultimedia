...
stroke(#CBA87B);
fill(#CBA87B);
rect(185,300,110,200); // empezamos por el cuello


stroke(#CBA87B);
fill(#CBA87B);
rect(150,130,180,170); // seguimos por la cara 
stroke(#CEAD85);
fill(#CEAD85);
triangle(240,320,150,175,330,175);
fill(#BFA485); //barba
rect(203,267,75,64); // damos forma a la cara con mandibula/pomulos
...
stroke(#0F0C07);
fill(#0F0C07);
rect(103,350,270,150); //agregamos detalles de la foto como la remera

stroke(#CEAD85);

fill(#CEAD85);
ellipse(140,210,23,57); // seguimos por las orejas 
...
stroke(#432E15); 
fill(#432E15);  //pelo y detalles para dar mas vida al retrato
...
stroke(#6C5346);
fill(#DED7D7);
ellipse(193,192,40,19); // armamos la primera parte de los ojos, para saber donde quedan mejor
...
line(245,244,240,210); // y una nariz sutil
...
rect(221,286,35,7);     //vamos por la boca
stroke(#B48585);
...
fill(#462525);
ellipse(193,193,27,17); // aca terminamos los detalles de los ojos
...
stroke(#B78557); //agregamos detalles como arrugas para acentuar su mirada
